...
{
	private final String[] price = {"50001-100000", "100001-200000", "200001-300000", "300001-400000", "400000-1000000", "1000000-2000000", "2000000+"};
	...
	private void nextButtonClicked()
	{
		if (currentIndex < carList.length - 1)
		{
			...
			JOptionPane.showMessageDialog(carSystem, "You can't navigate any further", "Sorry", JOptionPane.ERROR_MESSAGE);
	}
